# src/models/keras_lstm_model_2.py
...
class KerasLSTMModelV2(BaseModel):
    """
    ...
    def __init__(self, model_params: dict):
        ...
        self.lstm_units_1 = self.params.get('lstm_units_1', 128)
        self.lstm_units_2 = self.params.get('lstm_units_2', 96)
        self.lstm_units_3 = self.params.get('lstm_units_3', 64)
        self.lstm_units_4 = self.params.get('lstm_units_4', 32)
        self.dropout_rate_1 = self.params.get('dropout_rate_1', 0.2)
        self.dropout_rate_2 = self.params.get('dropout_rate_2', 0.4)
        self.dropout_rate_3 = self.params.get('dropout_rate_3', 0.2)
        self.dropout_rate_4 = self.params.get('dropout_rate_4', 0.4)
    ...
    def _build_model(self, input_shape, learning_rate):
        ...
        self.model = Sequential([
            ...
            LSTM(self.lstm_units_2, return_sequences=True),
            Dropout(self.dropout_rate_2),
            LSTM(self.lstm_units_3, return_sequences=True),
            Dropout(self.dropout_rate_3),
            LSTM(self.lstm_units_4),
            Dropout(self.dropout_rate_4),
    ...
    @classmethod
    def load(cls, path: Path) -> 'KerasLSTMModelV2':
        if not path.exists():
